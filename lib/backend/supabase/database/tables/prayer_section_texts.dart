...
class PrayerSectionTextsTable extends SupabaseTable<PrayerSectionTextsRow> {
  @override
  String get tableName => 'prayer_section_texts';

  @override
  PrayerSectionTextsRow createRow(Map<String, dynamic> data) =>
      PrayerSectionTextsRow(data);
}

class PrayerSectionTextsRow extends SupabaseDataRow {
  PrayerSectionTextsRow(super.data);

  @override
  SupabaseTable get table => PrayerSectionTextsTable();
