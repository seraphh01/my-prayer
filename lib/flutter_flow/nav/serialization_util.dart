    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case PrayerCategoryRow:
            return PrayerCategoryRow(data);
          case PrayerSectionTextsRow:
            return PrayerSectionTextsRow(data);
          ...
          case PrayerSubcategoryRow:
            return PrayerSubcategoryRow(data);
          case PrayerSectionsRow:
            return PrayerSectionsRow(data);
          case PrayersRow:
